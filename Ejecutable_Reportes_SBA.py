...
class MyGUI:
    def __init__(self):
        ...
        self.outer_Reporte_frame=tk.Frame(self.root)
        self.outer_Reporte_frame.pack(side='top',pady=10)

        self.BaseDoc_frame=tk.Frame(self.outer_Reporte_frame)
        self.BaseDoc_frame.pack(side='left',pady=10)
        ...
        self.FotosReporte_frame=tk.Frame(self.outer_Reporte_frame)
        ...
        self.outer_DB_frame=tk.Frame(self.root)
        self.outer_DB_frame.pack(side='top',pady=10)

        self.DB_frame=tk.Frame(self.outer_DB_frame)
        ...
        self.codsite_frame=tk.Frame(self.outer_DB_frame)
        ...
        self.lblsite_frame=tk.Frame(self.outer_DB_frame)
        self.lblsite_frame.pack(side='bottom',pady=10)
        self.lbl_codsite=tk.Label(self.lblsite_frame,text="-COD SITE-",font=('Arial',8))
        self.lbl_codsite.pack(side="bottom",padx=35)




        #EJECUTAR REPORTE
        self.outer_ejecucion_frame=tk.Frame(self.root)
        self.outer_ejecucion_frame.pack(side='top',pady=10)

        self.EjecutarReporte_frame=tk.Frame(self.outer_ejecucion_frame)
        ...
        self.Btn_Ejecucion.pack(side="left",padx=5)
        self.lbl_Ejecucion=tk.Label(self.EjecutarReporte_frame,text="-Sin Ejecutar-",font=('Arial',8))
        self.lbl_Ejecucion.pack(side="left",padx=35)
        self.Btn_Ejecucion_old=tk.Button(self.EjecutarReporte_frame,text="Ejecutar Antiguo",font=('Arial',12),command=self.ejecutar_old)
        self.Btn_Ejecucion_old.pack(side="left",padx=5)
        self.lbl_Ejecucion_old=tk.Label(self.EjecutarReporte_frame,text="-Sin Ejecutar-",font=('Arial',8))
        self.lbl_Ejecucion_old.pack(side="left",padx=35)

        #BUSCAR DOCUMENTO DE SALIDA 1_ESPAÑOL
        self.outer_traduccion_frame=tk.Frame(self.outer_ejecucion_frame)
        self.outer_traduccion_frame.pack(side='top',pady=10)




        self.PorTraducir_frame=tk.Frame(self.outer_traduccion_frame)
        self.PorTraducir_frame.pack(side='top',pady=10)
        ...
        self.Traduccion_frame=tk.Frame(self.outer_traduccion_frame)
        self.Traduccion_frame.pack(side='top',pady=10)
    ...
    def ejecutar_old(self):
        pass
        self.lbl_Ejecucion_old.config(text="-En ejecución-")
        ...
        #CERRAR EL DOCUMENTO DE EXCEL
        workbook.close()
        self.lbl_Ejecucion_old.config(text="-Listo-")
    def traducir(self):
        pass
        self.lbl_Traduccion.config(text="-En ejecución-")

                #%%%%%%%%%%%%%%%%%TRADUCCIONES%%%%%%%%%%%%%%%%%%%%%%%%%%
        directorio=get_folder_path(self.PorTraducir_path.get())
        ...
        for row in ws1.iter_rows(min_row=fila_ini, max_col=columna, max_row=fila_fin,min_col=columna):
            for cell in row:
                ...
                if textoInicial!="":
                        if textoInicial=="Sin comentarios":
                            Texto_Traducido="No comments"
                            cell.value=Texto_Traducido
                        elif textoInicial=="None":
                            Texto_Traducido="None"
                            cell.value=Texto_Traducido
                        elif textoInicial=="N/A":
                            Texto_Traducido="N/A"
                            cell.value=Texto_Traducido
                        else:
                            try:
